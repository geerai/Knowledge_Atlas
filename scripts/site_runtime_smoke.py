...
def run_suite(config: SmokeConfig) -> SmokeReport:
    ...
    page_checks = [
        ...
        ("Topic dashboard shell", "ka_topic_dashboard_view.html", ["Topic Page (Dashboard View)", "Current coordinated atlas dashboard", "paper_pnus"]),
        ...
        ("Theory journey shell", "ka_journey_theory.html", ["Current theory atlas companion", "data/ka_payloads/theories.json", "Theory deep-dive"]),
