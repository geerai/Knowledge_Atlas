...
*Last updated: 2026-04-19 (Option A approved by DK)*

## Track-level allocation (75 points — canonical)
...
| T4.b Scenario-based walkthrough on 3 archetype roles | Week 4 | Medium | 5 | `T4.b_scenarios.md` |
| **T4.b.2 Topic-page variant evaluation** | Week 4 | Medium-hard | 10 | `T4.b.2_topic_variant_evaluation.md` |
| T4.c Moderated usability pilot (n = 5) | Weeks 5–6 | Hard | 15 | `T4.c_usability_pilot.md` |
| T4.d Friction-point severity rubric + prioritised backlog | Week 6 | Medium-hard | 5 | `T4.d_severity_backlog.md` |
...
**Allocation note:** DK approved Option A on 2026-04-19. T4.b shrank from 10 → 5 pts (it now prepares the ground for T4.b.2 rather than being a full deliverable on its own), and T4.d shrank from 10 → 5 pts (T4.b.2 absorbs some of the severity-rating work that previously lived in T4.d). The 10 freed points went to the new T4.b.2 deliverable. Track total unchanged at 75.
